...
for ind1 in range(1,16):
    for ind2 in range(1,101):
        if (ind1 <10):
            ...
            in1='0'+str(ind1)
        if(ind2<10):
            path = 'resampled-to-8bit/class-'+str(in1)+'-sample-00'+str(ind2)+'-8bit.png'
        elif(ind2<100):
            path = 'resampled-to-8bit/class-'+str(in1)+'-sample-0'+str(ind2)+'-8bit.png'
        else:
            path = 'resampled-to-8bit/class-'+str(in1)+'-sample-'+str(ind2)+'-8bit.png'
        print("Path:",path)
